  ...
  describe('component', () => {
    ...
    describe('internal functions and events', () => {
      ...
      it('genCard() should instantiate the `card` prop and associate events', () => {
        ...
        jest.spyOn(wrapper.vm, 'onCardBlur').mockImplementation()
        jest.spyOn(wrapper.vm, 'onCardChange').mockImplementation()
        jest.spyOn(wrapper.vm, 'onCardFocus').mockImplementation()
        jest.spyOn(wrapper.vm, 'onCardReady').mockImplementation()
